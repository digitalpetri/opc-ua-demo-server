 ...
 * [StatusCodes.Bad_OutOfRange] when a value is written outside the configured EU
 * [org.eclipse.milo.opcua.stack.core.types.structured.Range], or [StatusCodes.Bad_TypeMismatch] if the value is not a
 * number.
 */
